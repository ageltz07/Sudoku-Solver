...
def is_valid(puzzle, guess, row, col):
    ...
    # this is tricky, but we want to get where the 3x3 squares starts
    #  and iterate over the 3 values in the row/columns
...
def solve_sudoku(puzzle):
    ...
    # step1.1: if there's nowhere left, then we'ere done because we only allowed valid inputs
    if row is None:
        return True
